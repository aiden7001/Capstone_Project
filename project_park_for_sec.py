...
# fullbody
# led connection and warning with led
...
face_for_park_cascade = cv2.CascadeClassifier('/home/pi/opencv-3.2.0/modules/objdetect/src/haarcascade_fullbody.xml')
    ...
    if fcounter == 20:
        ...
        for(x,y,w,h) in faces_for_park:     #people exist
            ...
            if(end_1 - start_1 > 3.0):
                ...
                time.sleep(2) #it has to be here because the speed of process is so fast.

            if(end_2 - start_2 > 3.0):
                print "===============================================================================" #Warning here
                print
                print"\t\t\t\tWARNING SECTION. 2"
                print
                print "==============================================================================="
